...
"For height->5, radius->1.0. getSurfaceArea->",16.01904224441409,invoke(obj,
...
String.format("For height->%.2f, radius->%.2f. getSurfaceArea->",h,r),_aimpl(h,r),
...
r=Double.parseDouble(String.format("%.2f",gen.nextDouble()+.5));double h=Double
.parseDouble(String.format("%.2f",gen.nextDouble()*5+2));obj=create(thisClass,
h,r);assertEquals(String.format("For height->%.2f, radius->%.2f. getSurfaceArea->"
